...
const activities = [
  {
    icon: Moon,
    title: 'Taraweeh-bønn',
    description: 'Nattlig Ramadan-bønn etter Isha kl. 20:00. Ledes av Hafiz Harun Abdullahi Mukhtar og Hafiz Ilyaas Omar Sayidahmed.',
    time: 'Etter Isha kl. 20:00 daglig',
